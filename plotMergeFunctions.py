...
def plotAll(targetTrajectories, agentTrajectories, plotDir=None):
    ...
    for j in range(agentTrajectories.shape[1]):  # itera su ogni agente
        ...
        plt.scatter(agent_x[0], agent_y[0], color='red', marker='x', s=100, zorder=4)  # Inizio agente
        plt.scatter(agent_x[-1], agent_y[-1], color='red', marker='^', s=100, zorder=4)  # Fine agente
